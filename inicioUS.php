...
<body>
    ...
    <main class="mian">
        ...
        <section class="group main__about__description">
            <div class="container container--flex">
                ...
                <div class="column column--50">
                    <h3 class="column__title">Trabajamos en tu comodidad y descanso</h3>
                    <p class="column__txt">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo repudiandae nostrum aspernatur enim facere dolorem magnam soluta vitae, doloribus iure voluptatibus laboriosam asperiores, quia necessitatibus. Officiis quo ducimus laudantium facere.</p>
                </div>
            </div>
        </section>
    ...
    <footer class="main-footer">
            <div class="container container--flex">
                ...
                <p class="copy">© 2021 Encuestas DLRT's | Todos los derechos reservados</p>
            </div>
        </footer>
